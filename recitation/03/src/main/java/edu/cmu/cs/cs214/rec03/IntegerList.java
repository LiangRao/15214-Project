...
public interface IntegerList {
	 ...
	 * 
	 * @param list
	 *            IntegerList containing elements to be added to the list
	 ...
	 * 
	 * @param num
	 *            an integer to be removed from the list, if present
	 ...
	 * 
	 * @param list
	 *            IntegerList containing elements to be removed from the list
	 * @return true if the list changed as a result of the call
	 */
